...
export const createDefaultIntakeState = (): GenoRootIntakePayload => ({
  ...
  section_B: {
    ...
    menstrual_cycle: '' as unknown as MenstrualCycleOption,
    pregnancy_related: '' as unknown as PregnancyRelatedOption,
    adult_acne_oily_skin: null as unknown as boolean,
    excess_body_facial_hair: null as unknown as boolean,
  },
  section_C: {
    past_6_months: [],
    habits: {
      smoking: null as unknown as boolean,
      smoking_severity: null,
      alcohol: null as unknown as boolean,
      hard_water: null as unknown as boolean,
      hair_wash_frequency: '' as unknown as HairWashFrequencyOption,
      heating_tools_styling_chemicals: null as unknown as boolean,
      salon_treatments: null as unknown as boolean,
  ...
  section_D: {
    ...
    past_treatment_side_effects: null as unknown as boolean,
